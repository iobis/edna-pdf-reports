...
Sequencing of the DNA from `r length(na.omit(json$stats$samples$locality))` samples resulted in over `r floor(json$stats$dna$reads / 1000000)` million sequence reads, from which we collected `r format(json$stats$dna$asvs, big.mark = ",")` unique sequences or ASVs (Tables \ref{tab:dna} and \ref{tab:samples}).
