...
render_report <- function() {
  params <- list(site_higherGeography = site_higherGeography, site_name_simplified = site_name_simplified, site_dates = site_dates, site_num_samples = site_num_samples)
